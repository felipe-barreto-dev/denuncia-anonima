    ...
    <div class="container">
        <ul class="list-group mt-3">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center denuncia">
                <div>
                    <h3>Assunto da Denúncia</h3>
                    <p>Descrição da denúncia ...</p>
                    <span class="data">Data da denúncia:</span>
                </div>
                <span class="badge bg-warning text-dark">Pendente</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center denuncia" data-status="concluida">
                <div class="denuncia-header">
                    <h3>Assunto da Denúncia Concluída</h3>
                    <p>Descrição da denúncia concluída ...</p>
                    <span class="data">Data da denúncia:</span>
                </div>
